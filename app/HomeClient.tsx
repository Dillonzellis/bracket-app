...
export default function HomeClient({ serverIsAdmin }: { serverIsAdmin: boolean }) {
      ...
      <div className="w-full max-w-md space-y-2">
        ...
        <div className="w-full max-w-md flex flex-col items-center">
          <div className="w-full mb-8">
            <EntrantsSection entrants={entrants} setEntrants={setEntrants} isAdmin={isAdmin} />
          </div>
          <img src="/melee-qr-bracket-300px.png" alt="QR Code" className="w-64 h-64 mb-8" />
        </div>
      )}
